...
function scoreAllFilings(filings) {
  ...
  // Apply cluster bonus — reduced from +40/+15 after backfill analysis showed
  // cluster buying is overweighted (75+ bracket underperforms 45-74 across all price levels)
